...
showBtn.onclick = async () => {        
    const id = Number(select.value);
    let [posts, comments] = await Promise.all([fetch(`https://jsonplaceholder.typicode.com/posts?userId=${id}`), fetch(`https://jsonplaceholder.typicode.com/comments?userId=${id}`)]);
